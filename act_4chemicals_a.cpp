...
// 4 chemicals
 ...
 a2a = pow(1 + (D / (2*Dp_1*lambda_1*ts)),-0.5);
 a2b = pow(1 + (D / (2*Dp_2*lambda_1*ts)),-0.5);
 a2c = pow(1 + (D / (2*Dp_3*lambda_1*ts)),-0.5);
 a2d = pow(1 + (D / (2*Dp_4*lambda_1*ts)),-0.5);


 cout<<((alpha_1*0.936237)/(4*pow(Dp_1,1.5)*sqrt(lambda_1)))*a2a - (alpha_2/(4*pow(Dp_2,1.5)*sqrt(lambda_2)))*a2b + ((alpha_3*0.907162)/(4*pow(Dp_3,1.5)*sqrt(lambda_3)))*a2c - ((alpha_4*0.939294)/(4*pow(Dp_4,1.5)*sqrt(lambda_4)))*a2d;
