...
// 4 chemicals
 ...
 double sum_a,sum_ab,ss,dist,a2,a2a;
 ...
 cout<<((alpha_1*0.936237)/(4*pow(Dp_1,1.5)*sqrt(lambda_1))) - ((alpha_4*0.939294)/(4*pow(Dp_4,1.5)*sqrt(lambda_4)));
 ...
 grad_2 [0] = 0; //sum_a * (2*Beta / pow(pi,0.5));
 ...
 grad_3 [0] = 0; //sum_a * (-2*Beta / pow(pi,0.5));
